...
# Read volume
# Example volumes here are binary one channel arrays
# TODO: Grayscale, color images disply
# assert array not boolean, if boolean convert to uint8
vol1 = np.load("vessel_tree_noise.npy").astype(np.uint8) * 255
vol2 = np.load("skeleton_vessel_tree_noise.npy")
# Prepare canvas
